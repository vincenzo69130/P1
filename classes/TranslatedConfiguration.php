...
class TranslatedConfigurationCore extends Configuration
{
    ...
    'fields' => array('value' => array('i18n' => true), 
    'date_add' => array('i18n' => true), 'date_upd' => array('i18n' => true)));
    public function __construct ($id = NULL, $id_lang = NULL)
    {
        ...
        if ($id !== null) {
            ...
            'SELECT `' . $this->identifier . '` FROM `' .
             pSQL(_DB_PREFIX_ . $this->table) . '_lang` WHERE `' .
             $this->identifier . '`=' . pSQL($id) . ' LIMIT 0,1');
