...
class StateCore extends ObjectModel
{
    ...
    public $active = true;
    protected $fieldsRequired = array('id_country', 'id_zone', 'iso_code', 
    'name');
    protected $fieldsSize = array('iso_code' => 4, 'name' => 32);
    protected $fieldsValidate = array('id_country' => 'isUnsignedId', 
    'id_zone' => 'isUnsignedId', 'iso_code' => 'isStateIsoCode', 
    'name' => 'isGenericName', 'active' => 'isBool');
    protected $table = 'state';
    protected $identifier = 'id_state';
    protected $webserviceParameters = array(
    'fields' => array('id_zone' => array('xlink_resource' => 'zones'), 
    ...
    public function delete ()
    {
        ...
        if (! $this->isUsed()) {
            ...
            if (method_exists($this, 'getTranslationsFieldsChild'))
                ...
                'DELETE FROM `' . pSQL(_DB_PREFIX_ . $this->table) .
