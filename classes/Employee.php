...
class EmployeeCore extends ObjectModel
{
    ...
    /** @var boolean Status */
    public $active = 1;
    protected $fieldsRequired = array('lastname', 'firstname', 'email', 
    'passwd', 'id_profile', 'id_lang');
    protected $fieldsSize = array('lastname' => 32, 'firstname' => 32, 
    'email' => 128, 'passwd' => 32, 'bo_color' => 32, 'bo_theme' => 32);
    protected $fieldsValidate = array('lastname' => 'isName', 
    'firstname' => 'isName', 'email' => 'isEmail', 'id_lang' => 'isUnsignedInt', 
    'passwd' => 'isPasswdAdmin', 'active' => 'isBool', 'id_profile' => 'isInt', 
    'bo_color' => 'isColor', 'bo_theme' => 'isGenericName', 
    'bo_uimode' => 'isGenericName', 'bo_show_screencast' => 'isBool');
    protected $table = 'employee';
    protected $identifier = 'id_employee';
    protected $webserviceParameters = array(
    'fields' => array('id_lang' => array('xlink_resource' => 'languages'), 
    ...
    public function add ($autodate = true, $nullValues = true)
    {
        ...
        strtotime('-' . Configuration::get('PS_PASSWD_TIME_BACK') . 'minutes'));
    ...
    public function getByEmail ($email, $passwd = NULL)
    {
        if (! Validate::isEmail($email) or
         ($passwd != NULL and ! Validate::isPasswd($passwd)))
    ...
    {
        if (! Validate::isUnsignedId($id_employee) or
         ! Validate::isPasswd($passwd, 8))
            die(Tools::displayError());
    ...
    {
        return ($this->id_profile == _PS_ADMIN_PROFILE_ and
         Employee::countProfile($this->id_profile, true) == 1 and $this->active);
    }
