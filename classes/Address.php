...
class AddressCore extends ObjectModel
{
    ...
    protected $fieldsRequired = array('id_country', 'alias', 'lastname', 
    'firstname', 'address1', 'city');
    protected $fieldsSize = array('alias' => 32, 'company' => 32, 
    'lastname' => 32, 'firstname' => 32, 'address1' => 128, 'address2' => 128, 
    'postcode' => 12, 'city' => 64, 'other' => 300, 'phone' => 16, 
    'phone_mobile' => 16, 'dni' => 16);
    protected $fieldsValidate = array('id_customer' => 'isNullOrUnsignedId', 
    'id_manufacturer' => 'isNullOrUnsignedId', 
    'id_supplier' => 'isNullOrUnsignedId', 'id_country' => 'isUnsignedId', 
    'id_state' => 'isNullOrUnsignedId', 'alias' => 'isGenericName', 
    'company' => 'isGenericName', 'lastname' => 'isName', 
    'vat_number' => 'isGenericName', 'firstname' => 'isName', 
    'address1' => 'isAddress', 'address2' => 'isAddress', 
    ...
    protected $webserviceParameters = array('objectsNodeName' => 'addresses', 
    'fields' => array('id_customer' => array('xlink_resource' => 'customers'), 
    ...
    public function __construct ($id_address = NULL, $id_lang = NULL)
    {
        ...
        if ($this->id) {
            ...
            'SELECT `name` FROM `' . _DB_PREFIX_ . 'country_lang`
												...
												AND `id_lang` = ' . ($id_lang ? (int) ($id_lang) : Configuration::get(
            'PS_LANG_DEFAULT')));
    ...
    public function validateController ($htmlentities = true)
    {
        ...
        if (class_exists('VatNumber', false))
            ...
            VatNumber::WebServiceCheck($this->vat_number));
        return $errors;
    }
    /**
    ...
    public static function getCountryAndState ($id_address)
    {
        ...
        $result = Db::getInstance(_PS_USE_SQL_SLAVE_)->getRow(
        '
		SELECT `id_country`, `id_state`, `vat_number`, `postcode` FROM `' .
         _DB_PREFIX_ . 'address`
		WHERE `id_address` = ' . (int) ($id_address));
    ...
    public static function getFirstCustomerAddressId ($id_customer, 
    $active = true)
    {
