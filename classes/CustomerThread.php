...
class CustomerThreadCore extends ObjectModel
{
    ...
    'id_contact' => 'isUnsignedId', 'id_customer' => 'isUnsignedId', 
    'id_order' => 'isUnsignedId', 'id_product' => 'isUnsignedId', 
    'email' => 'isEmail', 'token' => 'isGenericName');
    ...
    public function delete ()
    {
        ...
        'DELETE FROM `' . _DB_PREFIX_ .
         'customer_message` WHERE `id_customer_thread` = ' . (int) ($this->id));
