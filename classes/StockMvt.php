...
class StockMvtCore extends ObjectModel
{
    ...
    protected $fieldsRequired = array('id_product', 'id_stock_mvt_reason', 
    'quantity');
    protected $fieldsValidate = array('id_product' => 'isUnsignedId', 
    'id_product_attribute' => 'isUnsignedId', 'id_order' => 'isUnsignedId', 
    'id_employee' => 'isUnsignedId', 'quantity' => 'isInt', 
    'id_stock_mvt_reason' => 'isUnsignedId');
    protected $webserviceParameters = array(
    'objectsNodeName' => 'stock_movements', 'objectNodeName' => 'stock_movement', 
    'fields' => array('id_product' => array('xlink_resource' => 'products'), 
    ...
    public function add ($autodate = true, $nullValues = false, $update_quantity = true)
    {
        ...
        if ($this->id_product_attribute) {
            $product = new Product((int) $this->id_product, false, 
