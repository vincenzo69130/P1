...
class AddressControllerCore extends FrontController
{
    ...
    public function preProcess ()
    {
        ...
        if ($id_address) {
            ...
            if (Validate::isLoadedObject($this->_address) and Customer::customerHasAddress(
            (int) (self::$cookie->id_customer), (int) ($id_address))) {
        ...
        if (Tools::isSubmit('submitAddress')) {
            ...
            if ($country->isNeedDni() and (! Tools::getValue('dni') or
            ...
            if (! sizeof($this->errors)) {
                ...
                if ($result = $address->save()) {
                    ...
                    if ((bool) (Tools::getValue('select_address', false)) == true or (Tools::isSubmit(
                    'ajax') and Tools::getValue('type') == 'invoice')) {
