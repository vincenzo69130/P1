...
class Swift_Message_Attachment extends Swift_Message_Mime
{
    ...
    $type = "application/octet-stream", $encoding = "base64", $disposition = "attachment")
    {
        parent::__construct();
    ...
    public function setFileName ($name)
    {
        ...
        if ($this->headers->has("Content-Disposition")) {
            $this->headers->setAttribute("Content-Disposition", "filename", 
            $name);
        }
    }
    /**
