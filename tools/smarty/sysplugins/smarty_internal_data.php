...
class Smarty_Internal_Data
{
        ...
        if (is_array($tpl_var)) {
            ...
            if ($tpl_var != '' && isset($value)) {
                if (! isset($this->tpl_vars[$tpl_var])) {
                    $tpl_var_inst = $this->getVariable($tpl_var, null, true, 
                    false);
                    if ($tpl_var_inst instanceof Undefined_Smarty_Variable) {
     ...
     */
    public function getVariable ($_variable, $_ptr = null, $search_parents = true, 
    $error_enable = true)
    {
        if ($_ptr === null) {
            $_ptr = $this;
        ...
        if ($this->smarty->error_unassigned && $error_enable) {
            ...
            'Undefined Smarty variable "' . $_variable . '"');
        } else {
            if ($error_enable) {
                // force a notice
                $x = $$_variable;
    ...
    public function getConfigVariable ($_variable)
    {
        ...
        if ($this->smarty->error_unassigned) {
            throw new SmartyException(
            'Undefined config variable "' . $_variable . '"');
        } else {
            // force a notice
            $x = $$_variable;
            return null;
