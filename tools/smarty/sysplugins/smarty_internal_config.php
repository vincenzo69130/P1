...
class Smarty_Internal_Config
{
    ...
    public function getCompiledTimestamp ()
    {
        ...
        $this->getCompiledFilepath())) ? filemtime($this->getCompiledFilepath()) : false) : $this->compiled_timestamp;
    }
    /**
    ...
    public function compileConfigSource ()
    {
        ...
        $this->getCompiledFilepath(), $this->getCompiledConfig(), $this->smarty);
    }
    /*
    ...
    */
    public function loadConfigVars ($sections = null, $scope = 'local')
    {
        if ($this->data instanceof Smarty_Internal_Template) {
            ...
            $this->getConfigFilepath())] = array($this->getConfigFilepath(), 
        ...
        foreach ($_config_vars['vars'] as $variable => $value) {
            if ($this->smarty->config_overwrite ||
             ! isset($scope_ptr->config_vars[$variable])) {
                ...
                (array) $scope_ptr->config_vars[$variable], (array) $value);
            }
        }
        // scan sections
