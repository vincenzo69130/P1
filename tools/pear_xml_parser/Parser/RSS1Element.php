...
class XML_Feed_Parser_RSS1Element extends XML_Feed_Parser_RSS1
{
     ...
     * @var array
     */
    protected $map = array('id' => array('Id'), 'title' => array('Text'), 
    'link' => array('Link'), 'description' => array('Text'),  # or dc:description
...
'date' => array('Date'),  # dc:date
     ...
     * @var array
     */
    protected $compatMap = array('content' => array('content'), 
    'updated' => array('lastBuildDate'), 'published' => array('date'), 
    'subtitle' => array('description'), 'updated' => array('date'), 
    'author' => array('creator'), 'contributor' => array('contributor'));
    /**
