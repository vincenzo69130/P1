...
function smarty_function_html_radios ($params, &$smarty)
{
    ...
    if (isset($options)) {
        foreach ($options as $_key => $_val)
            ...
            $_val, $selected, $extra, $separator, $labels, $label_ids);
    } else {
...
function smarty_function_html_radios_output ($name, $value, $output, $selected, 
$extra, $separator, $labels, $label_ids)
{
    $_output = '';
    if ($labels) {
        if ($label_ids) {
            $_id = smarty_function_escape_special_chars(
            preg_replace('![^\w\-\.]!', '_', $name . '_' . $value));
