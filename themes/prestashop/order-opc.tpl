...
PrestaShop SA *} {if $PS_CATALOG_MODE} {capture name=path}{l s='Your
shopping cart'}{/capture} {include file="$tpl_dir./breadcrumb.tpl"}
...
<!-- End Shopping Cart -->
{if $isLogged AND !$isGuest} {include
file="$tpl_dir./order-address.tpl"} {else}
...
<!-- END Payment -->
{else} {capture name=path}{l s='Your shopping cart'}{/capture} {include
