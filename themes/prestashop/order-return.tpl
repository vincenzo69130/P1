...
<p>{l s='Your package must be returned to us within'} {$nbdaysreturn} {l
s='days of receiving your order.'}</p>
...
- {l s='Please print out the'} <a
	href="{$link->getPageLink('pdf-order-return.php', true)}?id_order_return={$orderRet->id|intval}">{l
s='PDF document'}</a> {l s='and slip it into your package.'} <br />
- {l s='Please see PDF document'} (<a
	href="{$link->getPageLink('pdf-order-return.php', true)}?id_order_return={$orderRet->id|intval}">{l
s='for the correct address'}</a>) <br />
<br />
{l s='Upon receiving your package, you will be notified by e-mail. We
will then begin processing the reimbursement of your order total.'} <br />
<br />
<a href="{$link->getPageLink('contact-form.php', true)}">{l s='Let us
know if you have any questions.'}</a> <br />
