...
* @copyright 2007-2011 PrestaShop SA * @version Release: $Revision: 7717
...
PrestaShop SA *} {if $comparator_max_item}
...
<form method="get"
	action="{$link->getPageLink('products-comparison.php', true)}"
	onsubmit="true">
<p><input type="submit" class="button" value="{l s='Compare'}"
	style="float: right" /> <input type="hidden"
	name="compare_product_list" class="compare_product_list" value="" /></p>
</form>
{/if}
