...
if ($id_tab = checkingTab($tab)) {
    ...
    if (Validate::isLoadedObject($adminObj)) {
        ...
        if ($adminObj->checkToken()) {
            ...
            if (! empty($action) and method_exists($adminObj, 
            ...
            if (! empty($action) and method_exists($adminObj, 
            'displayAjax' . Tools::toCamelCase($action)))
            ...
            die(
            Tools::jsonEncode(translate('Invalid security token')));
        }
    }
}
