...
if (CONFIG_SYS_VIEW_ONLY) {
    ...
    if ($image->loadImage($sessionImage)) {
        ...
        if (! @copy($sessionImage, $originalImage)) {
            ...
            if ($history->getNumRestorable() == 0 &&
             CONFIG_SYS_DEMO_ENABLE && sizeof($originalSessionImageInfo)) {
                @unlink(
