...
if (file_exists(
DIR_AJAX_EDIT_AREA . "reg_syntax" . DIRECTORY_SEPARATOR . getFileExt($path) .
 ".js")) {
...
<script type="text/javascript">
    ...
    ?>';
		...
		function()
		{
				...
				,language: "<?php
    echo (file_exists(
    DIR_AJAX_EDIT_AREA . 'langs' . DIRECTORY_SEPARATOR . CONFIG_LANG_INDEX .
     ".js") ? CONFIG_LANG_INDEX : 'en');
    ?>"
				,syntax: "<?php
    echo $syntax;
    ?>"	
