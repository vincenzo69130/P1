...
class AdminSubDomains extends AdminTab
{
    ...
    public function displayList ()
    {
        $this->displayWarning(
        $this->l(
        'Cookies are different on each subdomain of your Website. If you want to use the same cookie, please add here the subdomains used by your shop. The most common is "www".'));
    ...
    public function displayForm ($isMainTab = true)
    {
		...
		' . ($obj->id ? '<input type="hidden" name="id_' . $this->table .
         '" value="' . $obj->id . '" />' : '') . '
			<fieldset><legend><img src="../img/admin/subdomain.gif" /> ' .
         $this->l('Subdomains') . '</legend>
