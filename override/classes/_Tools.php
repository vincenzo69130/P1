...
class Tools extends ToolsCore
{
    ...
    public static function redirect ($url, $baseUri = __PS_BASE_URI__)
    {
        ...
        echo '<h1>Redirection automatique dans 5 secondes</h1><a href=' . $url .
         '>' . $url . '</a>';
        exit();
    }
    /**
    ...
    public static function displayAsDeprecated ()
    {
        if (_PS_DISPLAY_COMPATIBILITY_WARNING_) {
            ...
            $message = Tools::displayError('The function') . ' ' .
             $callee['function'] . ' (' . Tools::displayError('Line') . ' ' .
             $callee['line'] . ') ' .
             Tools::displayError(
        ...
        if (_PS_DISPLAY_COMPATIBILITY_WARNING_) {
            ...
            if (PS_USE_FIREPHP)
                ...
                'Parameter <strong>' . $parameter .
                 ...
                 '()</strong> is deprecated in <strong>' . $callee['file'] .
                 '</strong> on line <strong>' . $callee['Line'] .
                 '</strong><br />', 'deprecated parameter');
            else
                $message = Tools::displayError('The parameter') . ' ' .
                 $parameter . ' ' . Tools::displayError(' in function ') . ' ' .
                 $callee['function'] . ' (' . Tools::displayError('Line') . ' ' .
                 $callee['Line'] . ') ' .
                 Tools::displayError(
                'is deprecated and will be removed in the next major version.');
