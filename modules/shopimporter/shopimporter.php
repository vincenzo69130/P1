...
class shopimporter extends ImportModule
{
    ...
    public function __construct ()
    {
        ...
        'This module allows you to import your shop from another system into Prestashop.');
        $this->supportedImports = array(
        'language' => array('methodName' => 'getLangagues', 
        'name' => $this->l('Language'), 'className' => 'Language', 
        'label' => $this->l('Import Languages'), 'table' => 'lang', 
        'identifier' => 'id_lang', 'alterTable' => array('id_lang' => 'int(10)'), 
        ...
        'name' => $this->l('Currency'), 'className' => 'Currency', 
        'label' => $this->l('Import Currencies'), 'table' => 'currency', 
        'identifier' => 'id_currency', 
        'alterTable' => array('id_currency' => 'int(10)'), 'delete' => true, 
...
*/
									'zone' => array('methodName' => 'getZones', 'name' => $this->l('Zone'), 
        'className' => 'Zone', 'label' => $this->l('Import Zones'), 
        'table' => 'zone', 'identifier' => 'id_zone', 
        'alterTable' => array('id_zone' => 'int(10)'), 'delete' => true), 
        'country' => array('methodName' => 'getCountries', 
        'name' => $this->l('Country'), 'className' => 'Country', 
        'label' => $this->l('Import Countries'), 'table' => 'country', 
        'identifier' => 'id_country', 
        'foreign_key' => array('id_zone', 'id_currency'), 
        'alterTable' => array('id_country' => 'int(10)'), 'delete' => true, 
        'defaultId' => 'PS_COUNTRY_DEFAULT'), 
        'state' => array('methodName' => 'getStates', 
        'name' => $this->l('State'), 'className' => 'State', 
        'label' => $this->l('Import States'), 'table' => 'state', 
        'identifier' => 'id_state', 
        'foreign_key' => array('id_zone', 'id_country'), 
        'alterTable' => array('id_state' => 'int(10)'), 'delete' => true), 
        'group' => array('methodName' => 'getGroups', 
        'name' => $this->l('Group'), 'className' => 'Group', 
        'label' => $this->l('Import Groups'), 'table' => 'group', 
        'identifier' => 'id_group', 
        'alterTable' => array('id_group' => 'int(10)'), 'delete' => true), 
        'customer' => array('methodName' => 'getCustomers', 
        'name' => $this->l('Customer'), 'className' => 'Customer', 
        'label' => $this->l('Import Customers'), 'table' => 'customer', 
        'identifier' => 'id_customer', 'foreign_key' => array('id_group'), 
        'alterTable' => array('id_customer' => 'int(10)', 
        'passwd' => 'varchar(100)'), 'delete' => true, 
        'association' => array(
        array('table' => 'customer_group', 
        'fields' => array('id_customer', 'id_group'), 
        'matchTable' => array('customer', 'group')))), 
        'address' => array('methodName' => 'getAddresses', 
        'name' => $this->l('Address'), 'className' => 'Address', 
        'label' => $this->l('Import Addresses'), 'table' => 'address', 
        'identifier' => 'id_address', 
        'foreign_key' => array('id_country', 'id_state', 'id_customer'), 
        'alterTable' => array('id_address' => 'int(10)'), 'delete' => true), 
        'manufacturer' => array('methodName' => 'getManufacturers', 
        'name' => $this->l('Manufacturer'), 'className' => 'Manufacturer', 
        'label' => $this->l('Import Manufacturers'), 'table' => 'manufacturer', 
        'identifier' => 'id_manufacturer', 'delete' => true, 
        'alterTable' => array('id_manufacturer' => 'int(10)'), 
        'hasImage' => true), 
        'supplier' => array('methodName' => 'getSuppliers', 
        'name' => $this->l('Supplier'), 'className' => 'Supplier', 
        'label' => $this->l('Import Suppliers'), 'table' => 'supplier', 
        'identifier' => 'id_supplier', 'delete' => true, 
        'alterTable' => array('id_supplier' => 'int(10)'), 'hasImage' => true), 
        'category' => array('methodName' => 'getCategories', 
        'name' => $this->l('Category'), 'className' => 'Category', 
        'label' => $this->l('Import Categories'), 'table' => 'category', 
        'identifier' => 'id_category', 
        'alterTable' => array('id_category' => 'int(10)'), 'delete' => true, 
        'hasImage' => true), 
        'attributegroup' => array('methodName' => 'getAttributesGroups', 
        'name' => $this->l('AttributeGroup'), 'className' => 'AttributeGroup', 
        'label' => $this->l('Import Attributes Groups'), 
        'table' => 'attribute_group', 'identifier' => 'id_attribute_group', 
        'alterTable' => array('id_attribute_group' => 'int(10)'), 
        'delete' => true), 
        'attribute' => array('methodName' => 'getAttributes', 
        'name' => $this->l('Attribute'), 'className' => 'Attribute', 
        'label' => $this->l('Import Attributes'), 'table' => 'attribute', 
        'identifier' => 'id_attribute', 
        'alterTable' => array('id_attribute' => 'int(10)'), 
        'foreign_key' => array('id_attribute_group'), 'delete' => true), 
        'product' => array('methodName' => 'getProducts', 
        'name' => $this->l('Product'), 'className' => 'Product', 
        'label' => $this->l('Import Products'), 'table' => 'product', 
        'identifier' => 'id_product', 
        'alterTable' => array('id_product' => 'int(10)'), 
        'foreign_key' => array('id_category', 'id_manufacturer'), 
        'delete' => true, 
        'association' => array(
        array('table' => 'category_product', 
        'fields' => array('id_category', 'id_product'), 
        'matchTable' => array('category', 'product'))), 'hasImage' => true), 
        'combination' => array('methodName' => 'getProductsCombination', 
        'name' => $this->l('Combination'), 'className' => 'Combination', 
        'label' => $this->l('Import Products Combinations'), 
        'table' => 'product_attribute', 'identifier' => 'id_product_attribute', 
        'alterTable' => array('id_product_attribute' => 'int(10)', 
        'id_product' => 'int(10)'), 'foreign_key' => array('id_product'), 
        'delete' => false, 
        'association' => array(
        array('table' => 'product_attribute_combination', 
        ...
        'name' => $this->l('Orders States'), 'className' => 'OrderState', 
        'label' => $this->l('Import Orders States'), 'table' => 'order_state', 
        'identifier' => 'id_order_state', 
        'alterTable' => array('id_order_state' => 'int(10)')), 
        'cart' => array('methodName' => 'getOrders', 
        'name' => $this->l('Order'), 'className' => 'Cart', 
        'label' => $this->l('Import Orders'), 'table' => 'cart', 
        'identifier' => 'id_cart', 
        'foreign_key' => array('id_address_delivery', 'id_address_invoice', 
        'id_customer'), 'alterTable' => array('id_cart' => 'int(10)')), 
        'orderhistory' => array('methodName' => 'getOrdersHistory', 
        'name' => $this->l('Order history'), 'className' => 'Order history', 
        'label' => $this->l('Import Order History'), 'table' => 'order_history', 
        'identifier' => 'id_order_history', 
        'foreign_key' => array('id_order', 'id_order_state'), 
        'alterTable' => array('id_order_history' => 'int(10)'), 'hidden' => true), 
        'order' => array('methodName' => 'getOrders', 
        'name' => $this->l('Order'), 'className' => 'Order', 
        'label' => $this->l('Import Order History'), 'table' => 'orders', 
        'identifier' => 'id_order', 
        'alterTable' => array('id_order' => 'int(10)'), 'hidden' => true));
    }
    ...
    public function getContent ()
    {
        ...
        $html = '<script type="text/javascript">var globalAjaxShopImporterToken = "' .
         sha1(_COOKIE_KEY_ . 'ajaxShopImporter') . '";</script>
		<script type="text/javascript" src="../modules/shopimporter/shopimporter.js"></script>
				<script src="' .
         _PS_JS_DIR_ . 'jquery/jquery.scrollTo-1.4.2-min.js"></script>
				 <script type="text/javascript">
					var conf = new Array(); ';
        $i = 0;
        foreach ($this->supportedImports as $import) {
            if (! array_key_exists('hidden', $import))
                $html .= 'conf[' . $i . '] = new Array(\'' .
                 addslashes($import['methodName']) . '\', \'' .
                 addslashes($import['label']) . '\', \'' .
                 addslashes($import['className']) . '\', \'' .
                 addslashes($import['name']) . '\');';
            $i ++;
        }
        $html .= '	var notExist = "' .
         $this->l('is not available in this module') . '";
					var databaseOk = "' .
         $this->l('Connection to the database OK') . '";
					var wsOk = "' .
         $this->l('Connection to the web service OK') . '";
					var showErrors = "' . $this->l('Show errors') . '";
					var testImport = "' .
         $this->l('Test import process') . '";
					var runImport = "' . $this->l('Run Import') .
         '";
					var importHasErrors = "' .
         $this->l(
        'Errors occurred during import. For more details click on "Show errors".') . '"
					var importFinish = "' .
         $this->l('Import is complete.') . '"
					var truncateTable = "' . $this->l(
        'Remove data') . '"
					var oneThing = "' .
         $this->l('Please choose one thing to import') .
         '"
				</script>
				<style>
         ...
         $this->_path . 'logo.gif" alt="" />' .
         $this->l('Import from another system') . '</legend>
				<div class="warn" ><img src="../img/admin/warn2.png">
					' .
         $this->l('Before starting the import please backup your database. ') .
         '
						<a href="index.php?tab=AdminBackup&token=' .
         Tools::getAdminToken(
        'AdminBackup' . intval(Tab::getIdFromClassName('AdminBackup')) .
         intval($cookie->id_employee)) . '"">' . $this->l(
        ' Click here to backup') . '</a>
				</div>
				<br>
        ...
        if (sizeof($exportModules)) {
            $html .= '
				<label>' .
             $this->l('Choose your import') . ' : </label>
				<div class="margin-form">
					<select name="import_module_name" id="import_module_name">
						<option value="0">---</option>';
            foreach ($exportModules as $key => $module)
                (($module->name != $this->name and $module->id) ? $html .= '<option value="' .
                 $module->name . '">' . $module->displayName . '</option>' : '');
            $html .= '</select><input type="submit" class="button" id="choose_module_name" value="' .
             $this->l('Choose') . '">
				</div>';
        } else
            $html .= '<div class="warn" ><img src="../img/admin/warn2.png">' .
             $this->l('No import module installed') . '</div>';
        $html .= '
					<div style="display:none;" class="error" id="connectionInformation"></div>
					<div id="config_connector"></div>
					<div class="margin-form">
						<input type="submit" name="displayOptions" id="displayOptions" class="button" value="' .
         $this->l('Next Step') . '">
					</div>
					<hr>
        ...
        foreach ($this->supportedImports as $key => $import) {
            if (! array_key_exists('hidden', $import))
                $html .= '<label>' . $import['name'] .
                 ' : </label>
									<div class="margin-form">
										<label class="t" for="' .
                 $import['identifier'] . '_on' .
                 '"><img src="../img/admin/enabled.gif" alt="Yes" title="Yes"></label>
										<input type="radio" id="' .
                 $import['identifier'] . '_on' . '" name="' .
                 $import['methodName'] . '" class="' . $key .
                 '" value="1" checked="checked">
										<label class="t" for="' .
                 $import['identifier'] . '_off' .
                 '"><img src="../img/admin/disabled.gif" alt="No" title="No" style="margin-left: 10px;"></label>
										<input type="radio" id="' .
                 $import['identifier'] . '_off' . '" name="' .
                 $import['methodName'] . '" class="' . $key . '" value="0">
										' .
                 (array_key_exists('delete', $import) ? '
										<label class="t"><img src="../img/admin/delete.gif" alt="Delete" title="Delete"></label>
										<input type="checkbox" class="truncateTable" id="' .
                 $key . '" name="delete_' . $import['className'] . '">' : '') .
                 (array_key_exists('hasImage', $import) ? '
										<label class="t"><img src="../img/admin/picture.gif" alt="Images" title="Images"></label>
										<input type="checkbox" class="importImages" id="' .
                 $key . '" name="images_' . $import['className'] . '">' : '') .
                 (array_key_exists('info', $import) ? '<p>' . $import['info'] .
                 '</p>' : '') . '
									</div>';
        }
        $html .= '</div><hr>
					...
					' . $this->l(
        'This mode is dangerous') . '
					</div>
					<label>' .
         $this->l('Import for every') .
         ' : </label>
							<div class="margin-form">
								...
								<p>' .
         $this->l('Select the number of occurrences for each query to import') . '</p>
							</div>
					<label>' .
         $this->l('If errors occur') . ' : </label>
							<div class="margin-form">
								<label class="t"><img src="' .
         $this->_path . 'img/stop.png"></label>
								<input type="radio" name="hasErrors" id="hasErrors" value="0" checked="checked">
								<label class="t">' . $this->l('Stop') .
         '</label>
								<label class="t"><img src="' .
         $this->_path . 'img/skip.png" style="margin-left: 10px;"></label>
								<input type="radio" name="hasErrors" id="hasErrors" value="1">
								<label class="t">' . $this->l('Skip') .
         '</label>
								<label class="t"><img src="' .
         $this->_path . 'img/force.gif" style="margin-left: 10px;"></label>
								<input type="radio" name="hasErrors" id="hasErrors" value="2">
								<label class="t">' . $this->l('Force') .
         '</label>
								<p>' .
         $this->l(
        'Stop: if there are errors with the data, import will not run.') .
         '</p>
								<p>' .
         $this->l(
        'Skip: if there are errors with the data, import will skip incorrect data.') .
         '</p>
								<p>' .
         $this->l(
        'Force: if there are errors with the data, import will replace incorrect data by generic data.') . '</p>
							</div>
							<hr>
							<div style="display:none" id="specificOptions">
							<h2>' . $this->l('Specific Options') .
         '</h2>
							...
							<hr>
							<div class="margin-form">
							<input type="submit" class="button" name="checkAndSaveConfig" id="checkAndSaveConfig" value="' .
         $this->l('Next Step') . '">
						</div>
					</div>
				</div>
    ...
    public function genericImport ($className, $fields, $save = false)
    {
        ...
        $className);
        if ((sizeof($rules['requiredLang']) || sizeof($rules['sizeLang']) ||
         sizeof($rules['validateLang']) || Tools::isSubmit('syncLang') ||
         Tools::isSubmit('syncCurrency'))) {
            $moduleName = Tools::getValue('moduleName');
            if (file_exists('../../modules/' . $moduleName . '/' . $moduleName .
             '.php')) {
                require_once ('../../modules/' . $moduleName . '/' . $moduleName .
                 '.php');
                ...
                if (Tools::isSubmit('syncLang') || Tools::isSubmit('syncLangWS')) {
                    ...
                    $defaultLanguageImport = new Language(
                    Language::getIdByIso($languages[$defaultIdLand]['iso_code']));
                    if ($defaultLanguage->iso_code !=
                     $defaultLanguageImport->iso_code)
                        $errors[] = $this->l(
                        'Default language doesn\'t match : ') . '<br>' .
                         Configuration::get('PS_SHOP_NAME') . ' : ' .
                         $defaultLanguage->name .
                         ' ≠
											' .
                         $importModule->displayName . ' : ' .
                         $defaultLanguageImport->name . '<br>' .
                         $this->l(
                        'Please change default language in your configuration');
                }
                if (Tools::isSubmit('syncCurrency') ||
                 Tools::isSubmit('syncCurrencyWS')) {
                    ...
                    if (! empty($currencies[$defaultIdCurrency]['iso_code']))
                        $defaultCurrencyImport = new Currency(
                        (int) Currency::getIdByIsoCode(
                        $currencies[$defaultIdCurrency]['iso_code']));
                    else
                        $defaultCurrencyImport = new Currency(
                        (int) Currency::getIdByIsoCodeNum(
                        $currencies[$defaultIdCurrency]['iso_code_num']));
                    $defaultCurrency = new Currency(
                    (int) Configuration::get('PS_CURRENCY_DEFAULT'));
                    if ($defaultCurrency->iso_code !=
                     $defaultCurrencyImport->iso_code)
                        $errors[] = $this->l(
                        'Default currency doesn\'t match : ') . '<br>' .
                         Configuration::get('PS_SHOP_NAME') . ' : ' .
                         $defaultCurrency->name . ' ≠ ' .
                         $importModule->displayName . ' : ' .
                         $defaultCurrencyImport->name . '<br>' .
                         $this->l(
                        'Please change default currency in your configuration');
                }
                if (! empty($errors))
                    die(
                    '{"hasError" : true, "error" : ' . Tools::jsonEncode(
                    $errors) . '}');
            } else
                die(
                '{"hasError" : true, "error" : ["FATAL ERROR"], "datas" : []}');
        }
        foreach ($fields as $key => $field) {
            $id = $this->supportedImports[strtolower($className)]['identifier'];
            //remove wrong fields (ex : id_toto in Customer)
            foreach ($field as $name => $value)
                if (! array_key_exists($name, get_object_vars($object)) and
                 ($name != $id) and ($name != 'association') and
                 ($name != 'images') and (strtolower($className) != 'cart'))
                    unset($field[$name]);
            $return = $this->validateRules($rules, $field, $className, 
        ...
        if ($save || Tools::isSubmit('syncLang') || Tools::isSubmit(
        'syncLangWS')) {
            ...
            if ($className == 'Language') {
                ...
                //insert association
                if (array_key_exists('association', 
                $this->supportedImports[strtolower($className)]))
            ...
            if ($className == 'Category' and
             (sizeof($fields) != (int) Tools::getValue('nbr_import')))
                $this->updateCat();
        }
    ...
    public function genericImportWS ($className, $fields, $save = false)
    {
        ...
        $className);
        if ((sizeof($rules['requiredLang']) || sizeof($rules['sizeLang']) ||
         sizeof($rules['validateLang']) || Tools::isSubmit('syncLangWS') ||
         Tools::isSubmit('syncCurrency'))) {
            $moduleName = Tools::getValue('moduleName');
            if (file_exists('../../modules/' . $moduleName . '/' . $moduleName .
             '.php')) {
    ...
    private function saveObject ($className, $items)
    {
        ...
        foreach ($items as $item) {
            ...
            if (! $object->save(false, false))
                $return[] = array(
                $item[$this->supportedImports[strtolower($className)]['identifier']], 
                $this->l('An error occurred when adding the object'));
            else {
                $this->saveMatchId(strtolower($className), (int) $object->id, 
                (int) $id);
                if ($className == 'Customer')
                    Db::getInstance()->Execute(
                    'UPDATE ' . _DB_PREFIX_ . 'customer SET `passwd_' .
                     bqSQL(Tools::getValue('moduleName')) . '` = \'' .
                     pSQL($password) . '\' WHERE id_customer = ' .
                     (int) $object->id);
                if (array_key_exists('hasImage', 
                $this->supportedImports[strtolower($className)]) and
                 Tools::isSubmit('images_' . $className))
    ...
    private function saveOrders ($items)
    {
        ...
        //import cart product
        $foreignKey = $this->getForeignKey('Cart', 
        array('id_cart', 'id_product', 'id_product_attribute', 'id_customer', 
        ...
        foreach ($items as &$item) {
            foreach ($item['cart_products'] as $k => $cart_products) {
                ...
                Db::getInstance()->autoExecute(_DB_PREFIX_ . 'cart_product', 
                $item['cart_products'][$k], 'INSERT');
            }
            foreach ($item['order_products'] as $k => $order_products) {
                foreach ($order_products as $key => $val)
                    if (array_key_exists($key, $foreignKey) or
                     $key == 'product_id')
        ...
        $this->getForeignKey('Cart', array('id_order', 'id_order_state')), 
        $foreignKey);
        foreach ($items as &$item) {
                ...
                foreach ($order_products as $key => $val)
                    if (array_key_exists($key, $foreignKey))
                        if (array_key_exists($val, $foreignKey[$key]))
                            ...
                            $item['order_products'][$k][$key] = 0;
                Db::getInstance()->autoExecute(_DB_PREFIX_ . 'order_detail', 
                $item['order_products'][$k], 'INSERT');
            }
            //save order history
            foreach ($item['order_history'] as $k => $order_history) {
                ...
                Db::getInstance()->autoExecute(_DB_PREFIX_ . 'order_history', 
                $item['order_history'][$k], 'INSERT');
            }
        }
    }
    private function insertAssociation ($table, $items)
    {
        foreach ($this->supportedImports[$table]['association'] as $association) {
            ...
            if (! empty($items)) {
                    ...
                    foreach ($item as $key => $val)
                        if ($key == 'association' and ! empty($key))
                            foreach ($val[$tableAssociation] as $k => $v) {
                                $associatFields .= ' (' .
                                 ((array_key_exists($k, 
                                $match[$association['fields'][0]])) ? (int) $match[$association['fields'][0]][$k] : '1') .
                                 ', ';
                ...
                if ($associatFields != '')
                    Db::getInstance()->Execute(
                    'INSERT INTO `' . _DB_PREFIX_ . bqSQL($tableAssociation) .
                     '` (`' . $associatFieldsName . '`) VALUES ' .
                     rtrim($associatFields, ', '));
            }
        }
    }
    private function saveMatchId ($className, $psId, $matchId)
    {
        ...
        Db::getInstance()->Execute(
        'UPDATE `' . _DB_PREFIX_ . bqSQL($table) . '` SET `' . bqSQL(
        $identifier) . '_' . bqSQL($moduleName) . '` =  ' . (int) $matchId .
         ' WHERE `' . bqSQL($identifier) . '` = ' . (int) $psId);
    }
    private function getMatchId ($className)
    {
        ...
        'SELECT `' . bqSQL($identifier) . '_' . bqSQL($moduleName) . '`, `' .
         bqSQL($identifier) . '` FROM `' . _DB_PREFIX_ . bqSQL($table) .
         '` WHERE `' . bqSQL($identifier) . '_' . bqSQL($moduleName) . '` != 0 ');
        $match = array();
    ...
    {
        $defaultId = 1;
        if (array_key_exists('defaultId', 
        $this->supportedImports[strtolower($table)]))
            $defaultId = Configuration::get(
            $this->supportedImports[strtolower($table)]['defaultId']);
        return $defaultId;
    }
            ...
            if (array_key_exists('images', $item) && ! is_null($item['images']))
                foreach ($item['images'] as $key => $image) {
                    ...
                    if (@copy($image, $tmpfile)) {
                        ...
                        imageResize($tmpfile, 
                        $path . (int) $matchId[$item[$identifier]] . '.jpg');
                        if ($className == 'Product') {
                            $image = new Image();
                            $image->id_product = (int) ($matchId[$item[$identifier]]);
                            $image->cover = $cover;
                            $image->position = Image::getHighestPosition(
                            (int) $matchId[$item[$identifier]]) + 1;
                            $legend = array();
                            foreach ($item['name'] as $key => $val)
                                if (array_key_exists($key, $matchIdLang))
                                    $legend[$matchIdLang[$key]] = Tools::link_rewrite(
                                    $val);
                                else
                                    $legend[Configuration::get(
                                    'PS_LANG_DEFAULT')] = Tools::link_rewrite(
                                    $val);
                            $image->legend = $legend;
                            $image->add();
                            imageResize($tmpfile, 
                            $path . (int) $matchId[$item[$identifier]] . '-' .
                             (int) $image->id . '.jpg');
    ...
    private function replaceForeignKey (&$item, $table)
    {
        ...
        foreach ($foreingKey as $key) {
            ...
            if (array_key_exists($key, $foreingKeyValue) && $item[$key2] != 0)
                $item[$key2] = (array_key_exists($item[$key2], 
                $foreingKeyValue[$key]) ? $item[$key2] = $foreingKeyValue[$key][$item[$key2]] : $item[$key2] = 0);
            else
    ...
    private function alterTable ($className)
    {
        ...
        'SELECT * FROM `' . _DB_PREFIX_ . bqSQL($from) . '`');
        if (! $result)
            $result = array();
        foreach ($this->supportedImports[$className]['alterTable'] as $name => $type) {
            $moduleName = Tools::getValue('moduleName');
            Db::getInstance()->ExecuteS(
            "SHOW COLUMNS FROM `" . _DB_PREFIX_ . bqSQL($from) . "` LIKE '" .
             pSQL($name) . '_' . pSQL($moduleName) . "'");
            if (! Db::getInstance()->numRows() and
             ! array_key_exists($name . '_' . $moduleName, $result))
                $queryTmp .= ' ADD `' . $name . '_' . $moduleName . '` ' . $type .
                 ' NOT NULL,';
        }
        if (! empty($queryTmp)) {
    ...
    private function updateCat ()
    {
        ...
        'UPDATE
									...
									ON
									c.id_parent = c2.`id_category_' .
         bqSQL($moduleName) . '`
									SET
									c.id_parent = c2.id_category
									WHERE c.`id_category_' .
         bqSQL($moduleName) . '` != 0');
        $category = new Category();
        $cats = $category->getSimpleCategories(
        (int) Configuration::get('PS_LANG_DEFAULT'));
        foreach ($cats as $cat) {
    ...
    private function getForeignKey ($className, $foreign_key = null)
    {
        ...
        foreach ($foreign_key as $key) {
            if (in_array($key, 
            array('id_address_invoice', 'id_address_delivery')))
                $key2 = 'id_address';
            ...
            'SELECT `' . bqSQL($key2) . '_' . bqSQL($moduleName) . '`, `' .
             bqSQL($key2) . '` FROM `' . _DB_PREFIX_ . bqSQL($from) . '` WHERE `' .
             bqSQL($key2) . '_' . bqSQL($moduleName) . '` != 0');
            if (! empty($return))
    ...
    private function getForeignKeyLang ($table)
    {
        ...
        $moduleName = Tools::getValue('moduleName');
        $return = Db::getInstance()->ExecuteS(
        'SELECT `' . bqSQL($id) . '_' . bqSQL($moduleName) . '`, `' . bqSQL($id) .
         '` FROM `' . _DB_PREFIX_ . bqSQL($table) . '` WHERE `' . bqSQL($id) .
         '_' . bqSQL($moduleName) . '` != 0');
        $match = array();
        foreach ($return as $name => $val)
    ...
    private function getMatchIdLang ($order = 1)
    {
        $moduleName = Tools::getValue('moduleName');
        $return = Db::getInstance()->ExecuteS(
        'SELECT `id_lang`, `id_lang_' . bqSQL($moduleName) . '` FROM `' .
         _DB_PREFIX_ . 'lang' . '` WHERE `id_lang_' . bqSQL($moduleName) .
         '` != 0');
        $match = array();
        foreach ($return as $name => $val)
            if ((bool) $order)
    ...
    private function validateRules ($rules, &$fields, $className, $languages, 
    $defaultLanguage)
    {
        $returnErrors = array();
            ...
            if (($value = $fields[$field]) == false and (string) $value != '0')
                if ($hasErrors == 2) {
                    if (array_key_exists($field, $rules['size']))
                        ...
                        $size = 1;
                    $fields[$field] = $this->generateData($size, 
                    $rules['validate'][$field]);
                } else
                    $returnErrors[] = $this->l('the field') . ' <b>' .
                     call_user_func(array($className, 'displayFieldName'), 
                    $field, $className) . '</b> ' . $this->l('is required');
            /* Checking for maximum fields sizes */
        foreach ($rules['size'] as $field => $maxLength)
            if (array_key_exists($field, $fields) and $field != 'passwd')
                if ($fields[$field] !== false and
                 Tools::strlen($fields[$field]) > $maxLength)
                    if ($hasErrors == 2)
                        $fields[$field] = substr($fields[$field], 0, $maxLength);
                    else
                        $returnErrors[] = $this->l('the field') . ' <b>' .
                         call_user_func(array($className, 'displayFieldName'), 
                        $field, $className) . '</b>' . $this->l('is too long') .
                ...
                if (($value = $fields[$field]) !== false and ($field != 'passwd'))
                    if (! Validate::$function($value))
                        if ($hasErrors == 2) {
                            ...
                            $returnErrors[] = $this->l('the field') . ' <b>' .
                             call_user_func(
                            array($className, 'displayFieldName'), $field, 
                            $className) . '</b> ' . $this->l('is invalid');
        if ((sizeof($rules['requiredLang']) || sizeof($rules['sizeLang']) ||
         sizeof($rules['validateLang']))) {
            $matchIdLang = $this->getMatchIdLang(0);
            /* Checking for multilingual required fields */
            foreach ($rules['requiredLang'] as $fieldLang) {
                if (($empty = $fields[$fieldLang][$matchIdLang[$defaultLanguage->id]]) ===
                 false || empty($empty))
                    if ($hasErrors == 2) {
                        if (array_key_exists($fieldLang, $rules['sizeLang']))
                            ...
                            $size = 1;
                        $fields[$fieldLang][$matchIdLang[$defaultLanguage->id]] = $this->generateData(
                        $size, $rules['validateLang'][$fieldLang]);
                    } else
                        $returnErrors[] = $this->l('the field') . ' <b>' .
                         call_user_func(array($className, 'displayFieldName'), 
            ...
            foreach ($rules['sizeLang'] as $fieldLang => $maxLength)
                foreach ($languages as $language)
                    if (isset($fields[$fieldLang][$language['id_lang']]) &&
                     $fields[$fieldLang] !== false and
                     Tools::strlen($fields[$fieldLang][$language['id_lang']]) >
                     $maxLength)
                        if ($hasErrors == 2)
                            $fields[$fieldLang] = substr($fields[$fieldLang], 0, 
                            $maxLength);
                        else
                            $returnErrors[] = $this->l('the field') . ' <b>' .
                             call_user_func(
            ...
            foreach ($rules['validateLang'] as $fieldLang => $function)
                foreach ($languages as $language) {
                    if (array_key_exists($fieldLang, $fields) and
                     ($value = $fields[$fieldLang][$language['id_lang']]) !==
                     false and ! empty($value)) {
                        if (! Validate::$function($value))
                            if ($hasErrors == 2) {
                                if (array_key_exists($fieldLang, 
                                $rules['sizeLang']))
                                    $size = $rules['sizeLang'][$fieldLang];
                                else
                                    $size = 1;
                                $fields[$fieldLang][$language['id_lang']] = $this->generateData(
                                $size, $rules['validateLang'][$fieldLang]);
                            } else
                                $returnErrors[] = $this->l('the field') . ' <b>' .
                                 call_user_func(
                                array($className, 'displayFieldName'), 
    ...
    private function validateRulesWS ($rules, &$fields, $className, $languages, 
    $defaultLanguage)
    {
        $returnErrors = array();
        $hasErrors = Tools::getValue('hasErrors');
            ...
            if (! Language::isInstalled($iso)) {
                if ($add) {
                    if (@fsockopen('www.prestashop.com', 80)) {
                        if ($lang_pack = Tools::jsonDecode(
                        Tools::file_get_contents(
                        'http://www.prestashop.com/download/lang_packs/get_language_pack.php?version=' .
                         _PS_VERSION_ . '&iso_lang=' . $iso))) {
                            if ($content = Tools::file_get_contents(
                            'http://www.prestashop.com/download/lang_packs/gzip/' .
                             $lang_pack->version . '/' . $iso . '.gzip')) {
                                $file = _PS_TRANSLATIONS_DIR_ . $iso . '.gzip';
                                if (file_put_contents($file, $content)) {
                                    require_once ('../../tools/tar/Archive_Tar.php');
                                    $gz = new Archive_Tar($file, true);
                                    if ($gz->extract(
                                    _PS_TRANSLATIONS_DIR_ . '../', false)) {
                                        if (! Language::checkAndAddLanguage(
                                        $iso))
                ...
                'UPDATE  `' . _DB_PREFIX_ .
                 'lang`
											SET  `id_lang_' .
                 bqSQL($moduleName) . '` =  ' . (int) $language['id_lang'] . '
											WHERE  `id_lang` = ' . (int) $newId);
            }
        }
    }
    public function truncateTable ($table)
    {
        switch ($table) {
            case 'customer':
                ...
                Db::getInstance()->Execute(
                'TRUNCATE TABLE `' . _DB_PREFIX_ . 'customer_group');
                break;
            case 'address':
                Db::getInstance()->Execute(
            ...
            case 'country':
                Db::getInstance()->Execute(
                'TRUNCATE TABLE `' . _DB_PREFIX_ . 'state');
                Db::getInstance()->Execute(
                'TRUNCATE TABLE `' . _DB_PREFIX_ . 'country');
                Db::getInstance()->Execute(
                'TRUNCATE TABLE `' . _DB_PREFIX_ . 'country_lang');
                Db::getInstance()->Execute(
                'TRUNCATE TABLE `' . _DB_PREFIX_ . 'country');
            case 'group':
                Db::getInstance()->Execute(
                'TRUNCATE TABLE `' . _DB_PREFIX_ . 'customer_group');
                Db::getInstance()->Execute(
                'TRUNCATE TABLE `' . _DB_PREFIX_ . 'ps_group_lang');
                Db::getInstance()->Execute(
                'TRUNCATE TABLE `' . _DB_PREFIX_ . 'group');
                break;
            case 'combination':
                Db::getInstance()->Execute(
            ...
            case 'state':
                Db::getInstance()->Execute(
                'TRUNCATE TABLE `' . _DB_PREFIX_ . bqSQL($table) . '`');
                break;
        }
        return true;
    }
    ...
    private function generateData ($size = 1, $type)
    {
        ...
        switch ($type) {
            ...
            case 'LanguageCode':
                for ($i = 1; $i <= 2; $i ++)
                    $return .= substr($alphaNum, mt_rand(0, strlen($alphaNum)), 
                    1);
                $return .= '-';
                for ($i = 1; $i <= 2; $i ++)
                    $return .= substr($alphaNum, mt_rand(0, strlen($alphaNum)), 
    ...
    private function cartToOrder ($items, $foreignKey)
    {
        ...
        foreach ($items as $item) {
            ...
            $vat_address = new Address(
            (int) $foreignKey['id_address_delivery'][$item['id_address_delivery']]);
            ...
            if (! strlen(trim($item['payment'])))
                ...
                $order->payment = utf8_encode(
                html_entity_decode(
                strip_tags(Tools::substr($item['payment'], 0, 32))));
            if (isset($this->name))
            ...
            (int) $item['id_carrier'], 
            (int) $item[Configuration::get('PS_TAX_ADDRESS_TYPE')]);
