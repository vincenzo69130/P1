...
<!-- MODULE Loyalty -->
<li><a href="{$base_dir_ssl}modules/loyalty/loyalty-program.php"
	title="{l s='My loyalty points' mod='loyalty'}"><img
	src="{$module_template_dir}loyalty.gif"
	alt="{l s='My loyalty points' mod='loyalty'}" class="icon" /></a><a
	href="{$base_dir_ssl}modules/loyalty/loyalty-program.php"
	title="{l s='My loyalty points' mod='loyalty'}">{l s='My loyalty
points' mod='loyalty'}</a></li>
<!-- END : MODULE Loyalty -->