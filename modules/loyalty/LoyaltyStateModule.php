...
class LoyaltyStateModule extends ObjectModel
{
    ...
    public static function insertDefaultData ()
    {
        ...
        'en' => 'Awaiting validation', 'fr' => 'En attente de validation'));
        ...
        'default' => $loyaltyModule->getL('Available'), 'en' => 'Available', 
        'fr' => 'Disponible');
        ...
        'default' => $loyaltyModule->getL('Cancelled'), 'en' => 'Cancelled', 
        'fr' => 'Annulés');
        ...
        'en' => 'Already converted', 'fr' => 'Déjà convertis');
        ...
        foreach ($defaultTranslations as $loyaltyState) {
            $state = new LoyaltyStateModule(
            (int) $loyaltyState['id_loyalty_state']);
