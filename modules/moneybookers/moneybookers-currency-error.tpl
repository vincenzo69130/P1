...
<p class="payment_module"><a name="mb-error" style="color: #DA0F00;">{l
s='You cannot pay with Moneybookers with your present currency, please
choose another currency' mod='moneybookers'}</a></p>