...
class EditorialClass extends ObjectModel
{
    ...
    protected $fieldsValidateLang = array('body_title' => 'isGenericName', 
    'body_subheading' => 'isGenericName', 'body_paragraph' => 'isCleanHtml', 
        ...
        foreach ($languages as $language) {
            ...
            foreach ($fieldsArray as $field) {
                ...
                elseif (in_array($field, $this->fieldsRequiredLang))
                    $fields[$language['id_lang']][$field] = pSQL(
                    $this->{$field}[$defaultLanguage], true);
                else
            ...
            foreach ($languages as $language)
                foreach ($this->fieldsValidateLang as $field => $validation)
                    ...
                    $_POST[$field . '_' . (int) ($language['id_lang'])]))
                        $this->{$field}[(int) ($language['id_lang'])] = $_POST[$field .
