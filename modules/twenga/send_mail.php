...
if (file_exists($configPath)) {
    ...
    if ((sha1(Configuration::get('TWENGA_TOKEN') . _COOKIE_KEY_)) !=
     Tools::getValue('twenga_token'))
    ...
    $template = 'mail';
    $template_vars = array('{shop_url}' => Tools::getShopDomain(true), 
    '{trader_email}' => Configuration::get('PS_SHOP_EMAIL'), 
    '{shop_country}' => $country);
    Mail::Send($_POST['id_lang'], $template, $subject, $template_vars, $to, 
