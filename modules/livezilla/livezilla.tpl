...
<div style="margin: 10px 0">{if isset($LIVEZILLA_SCRIPT)}
{$LIVEZILLA_SCRIPT} {elseif isset($LIVEZILLA_URL)} <a
	href="javascript:void(window.open('{$LIVEZILLA_URL}chat.php','','width=590,height=610,left=0,top=0,resizable=yes,menubar=no,location=no,status=yes,scrollbars=yes'))">
<img src="{$LIVEZILLA_URL}image.php?id=01" width="191" height="69"
	border="0" alt="{l s='LiveZilla Live Help'}" /> </a>
<noscript>
<div><a href="{$LIVEZILLA_URL}chat.php" target="_blank">Start Live Help
Chat</a></div>
</noscript>
...
<noscript><img
	src="{$LIVEZILLA_URL}server.php?request=track&amp;output=nojcrpt"
	width="0" height="0" style="visibility: hidden" alt="" /></noscript>
{else} <img src="{$base_dir}modules/livezilla/offline.png" width="191"
	height="69" border="0" alt="LiveZilla" /> {/if}</div>