...
<p>{l s='Your order on' mod='paysafecard'} <span class="bold">{$shop_name}</span>
{l s='is complete.' mod='paysafecard'} <br />
<br />
{l s='You have chosen the' mod='paysafecard'} {$payment_name} {l
s='method.' mod='paysafecard'} <br />
<br />
<span class="bold">{l s='Your order will be sent very soon.'
mod='paysafecard'}</span> <br />
<br />
{l s='For any questions or for further information, please contact our'
mod='paysafecard'} <a href="{$base_dir_ssl}contact-form.php">{l
s='customer support' mod='paysafecard'}</a>.</p>
