...
class PaysafeCard extends PSCPrepaidServices
{
    ...
    'T' => 'https://customer.test.at.paysafecard.com/psccustomer/GetCustomerPanelServlet', 
    'P' => 'https://customer.cc.at.paysafecard.com/psccustomer/GetCustomerPanelServlet');
    protected $supported_currencies = array('EUR', 'GBP', 'CHF', 'USD', 'PLN', 
    'CZK', 'SEK', 'DKK', 'RON', 'NOK', 'ARS');
    protected $register_url = array(
    'en' => 'http://www.prestashop.com/partner/url.php?to=http://www.paysafecard.com/index.php?id=947&L=8', 
    ...
    public function getL ($key)
    {
        ...
        '(The payment module will not be displayed for customers using non configured currency.)'), 
        ...
        'Transaction could not be initiated due to connection problems. If the problem persists, please contact support.'), 
        ...
        'introduction' => $this->l(
        'Paysafecard is Europe’s first prepaid solution for payments over the Internet to comply with banking laws. Over the past years, paysafecard has become one of Europe’s leading alternative online payment solutions.'), 
