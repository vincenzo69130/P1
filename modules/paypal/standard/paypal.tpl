...
* @copyright 2007-2011 PrestaShop SA * @version Release: $Revision: 7827
...
<p class="payment_module"><a
	href="{$base_dir_ssl}modules/paypal/standard/redirect.php"
	title="{l s='Pay with PayPal' mod='paypal'}"> <img
	src="{$base_dir_ssl}modules/paypal/paypal.gif"
	alt="{l s='Pay with PayPal' mod='paypal'}" /> {l s='Pay with PayPal'
mod='paypal'} </a></p>
