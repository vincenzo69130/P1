...
$xml_response = isset($HTTP_RAW_POST_DATA) ? $HTTP_RAW_POST_DATA : file_get_contents(
"php://input");
...
switch ($root) {
    ...
    case "new-order-notification":
        ...
        $secure_cart = explode('|', 
        $data[$root]['shopping-cart']['merchant-private-data']['VALUE']);
        ...
        $gcheckout->validateOrder((int) $secure_cart[0], 
        Configuration::get('PS_OS_PAYMENT'), (float) $orderTotal, 
