    ...
    function GetXML ()
    {
        ...
        foreach ($this->results_arr as $result) {
            if ($result->shipping_name != "") {
                ...
                array('shipping-name' => $result->shipping_name, 
                ...
                $xml_data->Push('result', 
                array('address-id' => $result->address_id));
            ...
            if ((count($result->coupon_arr) != 0) ||
             (count($result->giftcert_arr) != 0)) {
                ...
                foreach ($result->coupon_arr as $curr_coupon) {
                    ...
                    $xml_data->Element('calculated-amount', 
                    $curr_coupon->coupon_amount, 
                    array('currency' => $this->currency));
