...
<script type="text/javascript"
	src="{$smarty.const._PS_JS_DIR_}jquery/jquery-1.4.4.min.js"></script>
<script type="text/javascript"
	src="{$smarty.const._PS_JS_DIR_}jquery/jquery-ui-1.8.10.custom.min.js"></script>
<link type="text/css" rel="stylesheet"
	href="{$smarty.const._PS_JS_DIR_}jquery/datepicker/datepicker.css" />
</head>
<body>