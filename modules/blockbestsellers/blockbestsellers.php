...
class BlockBestSellers extends Module
{
    ...
    public function getContent ()
    {
        ...
        if (Tools::isSubmit('submitBestSellers')) {
            Configuration::updateValue('PS_BLOCK_BESTSELLERS_DISPLAY', 
    ...
    public function displayForm ()
    {
        ...
        Configuration::get('PS_BLOCK_BESTSELLERS_DISPLAY')) ? 'checked="checked" ' : '') .
         '/>
        ...
        Configuration::get('PS_BLOCK_BESTSELLERS_DISPLAY')) ? 'checked="checked" ' : '') .
         ...
         $this->l('Show the block even if no product is available.') . '</p>
				...
				<center><input type="submit" name="submitBestSellers" value="' .
    ...
    public function hookRightColumn ($params)
    {
        ...
        if ($bestsellers)
            foreach ($bestsellers as $bestseller) {
                $bestseller['price'] = Tools::displayPrice(
                Product::getPriceStatic((int) ($bestseller['id_product'])), 
                $currency);
                $best_sellers[] = $bestseller;
            }
        $smarty->assign(
        array('best_sellers' => $best_sellers, 
