...
* @copyright 2007-2011 PrestaShop SA * @version Release: $Revision: 9219
...
PrestaShop SA *} {$jQueryOverload}

<link href="{$new_base_dir}/style.css" rel="stylesheet" type="text/css"
	media="all" />
