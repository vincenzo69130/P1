...
<!-- MODULE MailAlerts -->
<li><a href="{$base_dir_ssl}modules/mailalerts/myalerts.php"
	title="{l s='My alerts' mod='mailalerts'}"><img
	src="{$module_template_dir}logo.gif"
	alt="{l s='alerts' mod='mailalerts'}" class="icon" /></a> <a
	href="{$base_dir_ssl}modules/mailalerts/myalerts.php"
	title="{l s='My alerts' mod='mailalerts'}">{l s='My alerts'
mod='mailalerts'}</a></li>
